...
export const JUPITER_SLIPPAGE_BPS = Number(process.env.JUPITER_SLIPPAGE_BPS || 700);
...
export const POSITION_UPDATE_MS = Number(process.env.POSITION_UPDATE_MS || 15 * 60 * 1000);
...
export const GMGN_SIGNAL_POLL_MS = Number(process.env.GMGN_SIGNAL_POLL_MS || 60_000);
